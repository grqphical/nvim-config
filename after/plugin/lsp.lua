...
local function formatIfSupported()
    local supported_filetypes = { 'python', 'go', 'lua', 'rust', 'asm', "js", "ts", "svelte", "html", "css" }
...
require('mason').setup({
    ensure_installed = { 'mypy', 'ruff', 'black', 'gofumpt', 'goimports-reviser', 'golines', 'asmfmt', "prettier" },
})
